...
<body>
	...
	<nav>
		<ul class="navbar-left">
			...
			<div class="main-menu">
				<li class="menu menu1">
					<a href="admin-page1.php" class="active"><img src="../src/img/menu-icon/receipt-grey.svg"></a>
				</li>
				<li class="menu-active">
					<a href="admin-page2.php" class="passive"><img src="../src/img/menu-icon/event-red.svg"></a>
				</li>
				<li class="keluar">
	...
	<main>
		...
		<?php
			...
			$result = $mysqli->query("SELECT * FROM acara WHERE peserta LIKE '%Admin%'") or die($mysqli->error);
		?>
		<!-- database connection -->
