...
<body>
		...
		<ul class="navbar-left">
			...
			<div class="main-menu">
				...
				<li class="menu-active">
					<a href="komite-page3.php" class="active"><img src="../src/img/menu-icon/event-red.svg"></a>
				</li>
				<li class="keluar">
	...
	<main>
		...
		<?php
			...
			$result = $mysqli->query("SELECT * FROM acara WHERE peserta LIKE '%Komite Pembiayaan%'") or die($mysqli->error);
		?>
		<!-- database connection -->
